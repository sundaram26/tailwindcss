...
export const SVGLines = () => {
  return (
    <motion.div
      whileHover="animate"
      className="rounded-md flex items-center justify-between max-w-md w-full"
    >
      ...
      <div className="size-10 rounded-sm bg-neutral-100 relative z-20 translate-x-6 p-px overflow-hidden">
